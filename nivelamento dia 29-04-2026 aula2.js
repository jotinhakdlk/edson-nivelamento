...
// 42- exiba o elemento 1 da coluna dois da matriz [[5, 6], [7, 8]]
...
for(let i = 0; i < matriz4.length ;i++){
    for(let j = 0; j < matriz4.length; j++){
        SomaMatriz += matriz4[i][j];
    };
};

console.log(SomaMatriz)

// 45- Crie uma matriz 3x3 de 1 a 9
...
// 46- Exiba os elementos da diagonal principa da matris 3x3 criada

for(let i = 0; i < matriz5.length; i++){
    console.log(matriz5[i][i])
}

// 47- Altere o elemento da linha 0, coluna 1 da matriz para 10
console.log(matriz5[0][1])
matriz5[0][1] = 10
console.log(matriz5[0][1])

// 48- exiba a primeira linha  da matriz [[10, 20], [30, 40], [50, 60]]
let matriz6 = [
    [10, 20],
    [30, 40],
    [50, 60]
...
console.log(matriz6[0]);

// 49- Exbica a primeira coluna da matriz [[1, 2], [3,4], [5, 6]]
let matriz7 = [
    [1, 2], 
    [3, 4], 
    [5, 6]
...
for(let i = 0; i < matriz7.length; i++){
    console.log(matriz7[i][0])
}

// 50- Multiplique todos os elementos da matriz [[1, 2], [3, 4]] por dois
let matriz8 = [
    [1, 2],
    [3, 4]
];
...
for(let i = 0; i < matriz8.length; i++){
    ...
    for(let j = 0; j < matriz8[i].length; j++)
        MultMatriz8[i][j] = matriz8[i][j] * 2;
};

console.log(MultMatriz8)

// ===================== ATIVIDADES COM OBJETO =============================
...
console.log('usanddo foreach')
numeross.forEach(function(n){
    console.log(n);
});
console.log("Foreache arrow")
numeross.forEach(n=> console.log(n))
}
// --------------------------------

let FrutasArray = ["Maçã", "Banana", "Uva", "Abacate"];

for(let i=0;i<FrutasArray.length;i++){
    console.log(i)
};

FrutasArray.forEach(function(n){
    console.log(n);
});

FrutasArray.forEach(n => console.log(n))
